    ...
    return (
        <div>
            ...
            >
                    ...
                    <StaggerItem>
                        <div className="flex flex-wrap gap-3 sm:gap-4 rounded-2xl border border-border/50 bg-gradient-to-br from-accent/40 to-card p-4 shadow-sm h-full">
                            {securityBadges.map((badge) => (
                                <div
                                    key={badge.label}
                                    className="inline-flex h-fit items-center gap-2 sm:gap-3 rounded-full border border-border/60 bg-card px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm uppercase tracking-wide my-auto mx-auto"
                                >
                ...
                <StaggerChildren className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" stagger={0.1}>
                    {[
                        {
