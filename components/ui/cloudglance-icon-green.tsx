...
interface CloudGlanceIconGreenProps {
  width?: number;
  height?: number;
  className?: string;
}

export function CloudGlanceIconGreen({
  width = 16,
  height = 16,
  className = "",
}: CloudGlanceIconGreenProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 93.95 85.91"
      width={width}
      height={height}
      className={className}
      style={
