...
export function HeaderContent({ visible }: { visible?: boolean }) {
  ...
  const y = useTransform(scrollY, [0, 100], [0, 8]); // Reduced from 30 to 8
  ...
  return (
    <>
      ...
      <MobileNav visible={visible}>
          <MobileNavHeader className="flex items-center justify-between w-full px-4">
            <NavbarLogo
              logoSrc="/logos/Logo Icon Black.svg"
