      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {" "}
              border: theme === 'dark' ? 'border-[var(--success-light) / 0.4]' :
              'border-green-200',
            </p>
            <p
              style={{
        ...
        >
          ...
          <div
            style={{
              ...
              boxShadow:
                "0px 52.186px 14.233px var(--shadow-black), 0px 33.209px 12.651px var(--shadow-black-10), 0px 18.977px 11.07px var(--shadow-black), 0px 7.907px 7.907px var(--shadow-black-10), 0px 1.581px 4.744px var(--shadow-black-10)",
              boxSizing: "border-box",
            }}
          >
            <div
